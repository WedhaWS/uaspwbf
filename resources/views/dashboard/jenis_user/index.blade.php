...
@section('container')
    <div class="container">
        ...
        <a class="btn btn-outline-info btn-fw" href="{{ route('jenis_user.create') }}">Tambah Jenis Pengguna</a>
            ...
            <tbody>
                @foreach ($jenis_user as $jenis_user)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-secondary btn-sm" href="{{ route('jenis_user.edit', $jenis_user->id) }}">Edit</a>
