        ...
        <div class="bg-gray-900 rounded-3xl overflow-hidden mb-12 shadow-xl">
            <div class="p-8 sm:p-12 md:p-16 flex flex-col md:flex-row gap-8">
                <div class="md:w-7/12 text-white">
                    ...
                    <a href="{{ route('payment',$product->id) }}" class="w-full bg-yellow-400 text-black font-bold py-3 px-6 rounded-full hover:bg-yellow-500 transition duration-300 transform hover:scale-105">Buy Now</a>
                </div>
            </div>
        </div>
        @endforeach
